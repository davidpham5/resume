 ...
 * gh-pages
 */
angular.module("pham6App").service("ExpService", function() {
  return {
    ...
    education: {
      ...
      gradDate: "May 2006",
      funny:
        "In all my years schooling, I learned how to learn. I taught myself HTML, CSS, and Javascript. My passion for learning new things is what drives my education."
    },
    org: [
