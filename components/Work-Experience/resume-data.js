...
export const RESUME = {
  ...
  basics: {
    ...
    aboutMe:
      "My path into web development is a bit unusual. I studied history and sociology before teaching myself to code, and at the time it felt like a my career had nothing to do with my education. Looking back, those disciplines were actually the foundation — they trained me to think about systems in terms of people: how something works, what decisions were made, and what trade offs were considered. That instinct follows me into everything I build.",
    location: {
      city: "Silver Spring",
      region: "MD",
      countryCode: "US",
